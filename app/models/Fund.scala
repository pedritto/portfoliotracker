...
case class Fund (id: Long, name: String, quantity: Long, value: Long, buyValue: Long) extends KeyedEntity[Long]

object Fund {

  var funds = Set(
    Fund(1, "Water Total Refund", 1210L, 100L, 78L),
    Fund(2, "Best Ever Invest", 67L, 534L, 800L)
  )
